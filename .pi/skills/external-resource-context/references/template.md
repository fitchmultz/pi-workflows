...
- Access method: <agent_browser / file read / MCP name / manual screenshot>
...
- Access method: <package import / agent_browser / MCP name>

### Guidelines
- Status: <present / not applicable>
- Source type: <project file / external URL / inline in design system / no guidelines>
- Location: <path or URL>
- Access method: <file read / agent_browser>
...
- Location: <path or URL>
- Access method: <file read / agent_browser / introspection endpoint>
