...
- `subagent_type`: "workflows-frontend:code-reviewer"
...
- `subagent_type`: "workflows-frontend:security-reviewer"
...
2. Invoke document-reviewer to verify the updated Design Doc:
   - `subagent_type`: "workflows-frontend:document-reviewer"
...
3. When more than one Design Doc exists under `docs/design/`, invoke design-sync:
   - `subagent_type`: "workflows-frontend:design-sync"
...
- `subagent_type`: "workflows-frontend:task-executor-frontend"
...
- `subagent_type`: "workflows-frontend:quality-fixer-frontend"
