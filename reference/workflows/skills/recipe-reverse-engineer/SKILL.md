...
```
subagent_type: workflows:scope-discoverer
...
**Agent tool invocation**:
```
subagent_type: workflows:prd-creator
...
**Agent tool invocation**:
```
subagent_type: workflows:code-verifier
...
**Agent tool invocation**:
```
subagent_type: workflows:document-reviewer
...
**Agent tool invocation**:
```
subagent_type: workflows:technical-designer
...
```
subagent_type: workflows-frontend:technical-designer-frontend
...
**Agent tool invocation (per Design Doc)**:
```
subagent_type: workflows:technical-designer (or workflows-frontend:technical-designer-frontend for frontend Design Docs)
