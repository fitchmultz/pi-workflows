...
- `subagent_type`: "workflows:code-reviewer"
...
- `subagent_type`: "workflows:security-reviewer"
...
3. When more than one Design Doc exists under `docs/design/`, invoke design-sync:
   - `subagent_type`: "workflows:design-sync"
...
- `subagent_type`: "workflows:task-executor"
...
- `subagent_type`: "workflows:quality-fixer"
