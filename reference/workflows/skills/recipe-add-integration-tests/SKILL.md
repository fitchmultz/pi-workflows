...
- `subagent_type`: "workflows:acceptance-test-generator"
...
- Backend or single-layer → `subagent_type`: "workflows:task-executor"
- Frontend → `subagent_type`: "workflows-frontend:task-executor-frontend"
...
- `subagent_type`: "workflows:integration-test-reviewer"
...
- Backend or single-layer → `subagent_type`: "workflows:quality-fixer"
- Frontend → `subagent_type`: "workflows-frontend:quality-fixer-frontend"
