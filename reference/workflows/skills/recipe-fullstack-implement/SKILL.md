...
- Pass all Design Docs to work-planner (subagent_type: "workflows:work-planner") with vertical slicing instruction
...
After acceptance-test-generator execution, when invoking work-planner (subagent_type: "workflows:work-planner"), communicate:
