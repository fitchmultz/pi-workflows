...
- `subagent_type`: "workflows-fullstack:acceptance-test-generator"
...
- Backend or single-layer → `subagent_type`: "workflows-fullstack:task-executor"
- Frontend → `subagent_type`: "workflows-fullstack:task-executor-frontend"
...
- `subagent_type`: "workflows-fullstack:integration-test-reviewer"
...
- Backend or single-layer → `subagent_type`: "workflows-fullstack:quality-fixer"
- Frontend → `subagent_type`: "workflows-fullstack:quality-fixer-frontend"
