...
- `subagent_type`: "workflows-fullstack:code-reviewer"
...
- `subagent_type`: "workflows-fullstack:security-reviewer"
...
3. When more than one Design Doc exists under `docs/design/`, invoke design-sync:
   - `subagent_type`: "workflows-fullstack:design-sync"
...
- `subagent_type`: "workflows-fullstack:task-executor-frontend"
...
- `subagent_type`: "workflows-fullstack:quality-fixer-frontend"
