...
```
subagent_type: workflows-fullstack:scope-discoverer
...
**Agent tool invocation**:
```
subagent_type: workflows-fullstack:prd-creator
...
**Agent tool invocation**:
```
subagent_type: workflows-fullstack:code-verifier
...
**Agent tool invocation**:
```
subagent_type: workflows-fullstack:document-reviewer
...
**Agent tool invocation**:
```
subagent_type: workflows-fullstack:technical-designer
...
```
subagent_type: workflows-fullstack:technical-designer-frontend
...
**Agent tool invocation (per Design Doc)**:
```
subagent_type: workflows-fullstack:technical-designer (or workflows-fullstack:technical-designer-frontend for frontend Design Docs)
