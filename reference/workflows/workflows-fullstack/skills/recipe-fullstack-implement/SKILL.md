...
- Pass all Design Docs to work-planner (subagent_type: "workflows-fullstack:work-planner") with vertical slicing instruction
...
After acceptance-test-generator execution, when invoking work-planner (subagent_type: "workflows-fullstack:work-planner"), communicate:
