...
1. **EXECUTE**: invoke Agent tool (subagent_type: "workflows-fullstack:task-executor") → Record the current HEAD as `diffBase`, pass `task_file: [path]`, and receive the structured response
